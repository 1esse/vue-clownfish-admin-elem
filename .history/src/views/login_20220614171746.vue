...
<template>
  <main class="main">
    <section class="login-wrapper">
      ...
      <el-form ref="loginForm" label-width="0" :model="form" class="login-form shadow" size="large">
        ...
        <ElButton type="primary" style="width: 100%;" size="large" :loading="loading.login"
