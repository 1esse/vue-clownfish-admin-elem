...
<template>
  ...
  <MenuPanel ref="menuPanelDom">
    <ElButton type="" plain @click="refreshPage(menuPanelDom?.getContext())">
      <ElIcon>
        <RefreshLeft />
      </ElIcon>
      刷新
    </ElButton>
    <ElButton type="" plain @click="closeTab(menuPanelDom?.getContext())">
      <Close />
      关闭
    </ElButton>
    <ElButton type="" plain @click="closeOtherTabs(menuPanelDom?.getContext())">
      <Close />
      关闭其他
    </ElButton>
    <ElButton type="" plain @click="closeAllTabs()">
      <Close />
      关闭所有
    </ElButton>
  </MenuPanel>
