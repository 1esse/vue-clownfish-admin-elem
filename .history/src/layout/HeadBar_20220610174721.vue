...
import { Fold, Right } from '@element-plus/icons-vue'
...
<template>
  <header>
    <section>
      <ElIcon>
        <Fold :class="['icon-sidebar-trigger', sidebarRelated?.collapsed && 'collapsed']"
    ...
    <section>
      ...
      <ElButton type="primary" circle :loading="loading?.logout" @click="logout" title="退出登录">
        <Right />
      </ElButton>
    </section>
  </header>
