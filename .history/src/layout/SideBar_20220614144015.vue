...
const getNavIcon = (item: RouteMeta | undefined) => {
  ...
  return (
    <ElIcon size="0.9rem" style="padding: 0.5rem; border-radius: 0.3rem; box-shadow: 0 1.25rem 1.68rem #0000000d; width: auto; height: auto;">
...
const TheSideBar = () => (
  <Scrollbar>
    <ElMenu class="menu-vertical" mode="vertical" collapse={sidebarRelated?.collapsed} defaultActive={defaultActive.value} defaultOpeneds={defaultOpeneds.value}>
...
<template>
  <template>
    <el-menu default-active="2" class="el-menu-vertical-demo" :collapse="sidebarRelated?.collapsed">
      <el-sub-menu index="1">
        <template #title>
          <el-icon>
            <location />
