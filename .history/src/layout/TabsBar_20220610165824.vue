...
<template>
  ...
  <MenuPanel ref="menuPanelDom">
    <ElButton type="text" @click="refreshPage(menuPanelDom?.getContext())">
      <el-icon>
        <RefreshLeft />
      </el-icon> 刷新
    </ElButton>
    <ElButton type="text" @click="closeTab(menuPanelDom?.getContext())">
      <el-icon>
        <Close />
      </el-icon> 关闭
    </ElButton>
    <ElButton type="text" @click="closeOtherTabs(menuPanelDom?.getContext())">
      <el-icon>
        <Close />
      </el-icon> 关闭其他
    </ElButton>
    <ElButton type="text" @click="closeAllTabs()">
      <el-icon>
        <Close />
      </el-icon> 关闭所有
    </ElButton>
