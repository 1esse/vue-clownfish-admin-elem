...
const TheSideBar = () => (
  <Scrollbar>
    <ElMenu class="menu-vertical" mode="vertical" collapse={sidebarRelated?.collapsed} defaultActive={defaultActive.value} defaultOpeneds={defaultOpeneds.value} collapseTransition={false} onSelect={onMenuSelect}>
...
function onMenuSelect(path: string) {
  const lastIndex = defaultActive.value
  if (path.startsWith('/http')) {
    defaultActive.value = lastIndex
  }
}
</script>
