...
const routes: RouteRecordRaw[] = [
  {
    ...
    component: Layout,
    redirect: '/test/test2',
    meta: { title: '测试菜单', icon: markRaw(CoffeeCup) },
    children: [
      {
        path: 'test1',
        name: 'Test1',
        component: () => import('@/views/test/test1.vue'),
        meta: { title: '缓存页', keepAlive: true, icon: markRaw(CoffeeCup) }
      },
      {
        path: 'test2',
        name: 'Test2',
        component: () => import('@/views/test/test2.vue'),
        meta: { title: '普通页', icon: markRaw(CoffeeCup) }
      },
      {
        path: 'test3',
        name: 'Test3',
        ...
        children: [
          ...
          },
          {
            ...
            meta: { title: '嵌套页子容器2', icon: markRaw(CoffeeCup) },
          }
        ]
      }
    ]
